...
pub const BITCOIN_REGTEST_STACKS_31_BURN_HEIGHT: u64 = 8001;
...
lazy_static! {
    pub static ref STACKS_EPOCHS_REGTEST: EpochList = EpochList::new(&[
        ...
        StacksEpoch {
            ...
            end_height: BITCOIN_REGTEST_STACKS_31_BURN_HEIGHT,
            block_limit: BLOCK_LIMIT_MAINNET_21.clone(),
            network_epoch: PEER_VERSION_EPOCH_3_0
        },
        StacksEpoch {
            epoch_id: StacksEpochId::Epoch31,
            start_height: BITCOIN_REGTEST_STACKS_31_BURN_HEIGHT,
            end_height: STACKS_EPOCH_MAX,
            block_limit: BLOCK_LIMIT_MAINNET_21.clone(),
            network_epoch: PEER_VERSION_EPOCH_3_1
        },
